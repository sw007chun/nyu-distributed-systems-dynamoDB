defmodule DynamoTest do
  ...
  test "tcp connection" do
    ...
    [node1] = LocalCluster.start_nodes("node-1", 1, [
      files: [__ENV__.file],
      environment: [
        dynamo: [
    ...
    [node2] = LocalCluster.start_nodes("node-2", 1, [
      files: [__ENV__.file],
      environment: [
        dynamo: [
    ...
    [node3] = LocalCluster.start_nodes("node-3", 1, [
      files: [__ENV__.file],
      environment: [
        dynamo: [
    ...
    Node.spawn(node2, fn -> KV.put_single("hello", "baz", 548063113999088594326381812268606132370974703616) end)
    Process.sleep(100)
